...
public class FaceVoiceAttach {
	...
	public boolean isPicture() {
		return FaceConstants.picContentTypes.contains(type);
	}

	public boolean isMusic() {
		return FaceConstants.musicContentTypes.contains(type);
	}

	public boolean isVideo() {
		return FaceConstants.videoContentTypes.contains(type);
	}
