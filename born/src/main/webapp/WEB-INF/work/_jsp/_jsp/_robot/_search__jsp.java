...
public class _search__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      if (_caucho_expr_10.evalBoolean(_jsp_env)) {
        ...
        Object _jsp_oldVar_2 = pageContext.getAttribute("bindedRobot");
        while (_jsp_iter_2.hasNext()) {
          Object _jsp_i_2 = _jsp_iter_2.next();
          pageContext.setAttribute("bindedRobot", _jsp_i_2);
        ...
        pageContext.pageSetOrRemove("bindedRobot", _jsp_oldVar_2);
      ...
      if (_caucho_expr_16.evalBoolean(_jsp_env)) {
        ...
        if (_jsp_loop_0 == null)
          _jsp_loop_0 = new com.caucho.jsp.IteratorLoopSupportTag();
        java.lang.Object _jsp_items_3 = _caucho_expr_17.evalObject(_jsp_env);
      ...
      if (_caucho_expr_26.evalBoolean(_jsp_env)) {
        ...
        int _jsp_begin_4 = (int) _caucho_expr_32.evalLong(_jsp_env);
        int _jsp_end_4 = (int) _caucho_expr_33.evalLong(_jsp_env);
        _jsp_loop_1.init(_jsp_begin_4, _jsp_end_4, 1);
        Object _jsp_status_4 = pageContext.putAttribute("status", _jsp_loop_1);
        for (int _jsp_i_4 = _jsp_begin_4; _jsp_i_4 <= _jsp_end_4; _jsp_i_4 += 1) {
    ...
    throws ServletException
  {
    ...
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty bindedRobots}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${bindedRobots }");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${bindedRobot.uuid }");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${uuid ==  bindedRobot.uuid}");
    _caucho_expr_14 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${startTime }");
    _caucho_expr_15 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${endTime }");
    _caucho_expr_16 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty robotOnlineData}");
    _caucho_expr_17 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${robotOnlineData }");
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.voltage }");
    _caucho_expr_19 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.current }");
    _caucho_expr_20 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.mode }");
    _caucho_expr_21 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.postionX }");
    _caucho_expr_22 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.postionY }");
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.alarmStatus }");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.formattedCollectTime }");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty robotOnlineData}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.totalPage >1}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage != 1}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.url }");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage - 1}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage == 5}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage > 5}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.startPage}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.endPage}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${status.current == page.currentPage }");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${status.current}");
    _caucho_expr_36 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${status.current != page.currentPage }");
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage + 4 == page.totalPage}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.totalPage}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage + 4 < page.totalPage}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.totalPage != page.currentPage }");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page.currentPage + 1}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("jsp/robot/search.jsp"), -2991837450136358819L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string52 = "\" class=\"next\" rel=\"nofollow\">Next<i class=\"icon\"></i></a>\r\n	    	".toCharArray();
    ...
    _jsp_string39 = "&page=1\">1</a>\r\n			".toCharArray();
    _jsp_string12 = "\r\n			<a href=\"/user/login\">\u767b\u5f55</a>\r\n		".toCharArray();
    _jsp_string45 = "\">".toCharArray();
    _jsp_string18 = "\r\n							".toCharArray();
    _jsp_string56 = "/js/leftNavigation.js\"></script>\r\n	<script src=\"".toCharArray();
    _jsp_string25 = "\r\n					</select>\r\n					<label for=\"meeting\">\u91c7\u96c6\u5f00\u59cb\u65f6\u95f4\uff1a</label>\r\n					<input id=\"datetimepicker1\"  type=\"text\"  name=\"startTime\" value=\"".toCharArray();
    _jsp_string19 = "\r\n								<option value=\"".toCharArray();
    _jsp_string55 = "/js/jquery-1.9.1.js\"></script>\r\n	<script src=\"".toCharArray();
    _jsp_string31 = "</td>\r\n				               	</tr>\r\n							".toCharArray();
    _jsp_string48 = "\r\n   			".toCharArray();
    ...
    _jsp_string37 = "\" class=\"prev\" rel=\"nofollow\"><i class=\"icon\">\uf104</i>Previous</a>\r\n			".toCharArray();
    _jsp_string5 = "><a href=\"/\">\u9996\u9875</a></li>\r\n		<li ".toCharArray();
    _jsp_string36 = "&page=".toCharArray();
    _jsp_string40 = "&page=1\">1</a>\r\n				<strong class=\"omit\">...</strong>\r\n			".toCharArray();
    _jsp_string50 = "\r\n				<strong class=\"omit\">...</strong>\r\n				<a href=\"".toCharArray();
    _jsp_string9 = "\r\n			<a href=\"/user/login\">".toCharArray();
    _jsp_string24 = "\r\n						".toCharArray();
    _jsp_string42 = "\r\n	            	<strong>".toCharArray();
    _jsp_string57 = "/js/searchForm.js\"></script>\r\n	<script src=\"".toCharArray();
    _jsp_string41 = "\r\n				".toCharArray();
    _jsp_string16 = " \">\r\n						<a href=\"/robot\">\u8bbe\u5907\u5217\u8868</a>\r\n					</div>\r\n					<div class=\"menuItem ".toCharArray();
    ...
    _jsp_string47 = "\r\n	    	".toCharArray();
    _jsp_string11 = "\r\n		".toCharArray();
    _jsp_string26 = "\" style=\"margin:0 5px; height:25px\"/>\r\n					<label for=\"meeting\">\u91c7\u96c6\u7ed3\u675f\u65f6\u95f4\uff1a</label>\r\n					<input id=\"datetimepicker2\"  type=\"text\"  name=\"endTime\" value=\"".toCharArray();
    _jsp_string44 = "\r\n				 	<a href=\"".toCharArray();
